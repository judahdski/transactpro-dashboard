        ...
        <div>
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-6 py-5 overflow-y-auto bg-white border-r border-solid border-[#E7E8EC]">
                    <a href="" className="flex justify-center items-center h-[65px] -mt-5 -mx-6 mb-6">
                        <img src={logo} alt="" />
                    </a>
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <NavLink
                                ...
                                onClick={() => handleChangeNavText('Input Transaksi')}
                            >
                                <svg
                                    aria-hidden="true"
                    ...
                    <ul className="block sm:hidden absolute bottom-0 pt-4 mb-4 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
