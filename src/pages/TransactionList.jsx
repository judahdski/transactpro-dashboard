                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {transactions.map(({ nomorTransaksi, tanggal, namaCustomer, jumlahBarang, subTotal, diskon, ongkir, total }, index) => (
                            <tr className="bg-white dark:bg-gray-800" key={index}>
                                ...
                                <td className="px-6 py-4">{nomorTransaksi}</td>
                                <td className="px-6 py-4">{tanggal}</td>
                                <td className="px-6 py-4">{namaCustomer}</td>
                                <td className="px-6 py-4">{jumlahBarang}</td>
                                <td className="px-6 py-4">Rp {subTotal.toLocaleString()}</td>
                                <td className="px-6 py-4">Rp {diskon.toLocaleString()}</td>
                                <td className="px-6 py-4">Rp {ongkir.toLocaleString()}</td>
                    ...
                    <tfoot>
                        <tr className="font-semibold text-gray-900 dark:text-white">
                            ...
                            <td className="px-6 py-3"></td>
                            <td className="px-6 py-3"></td>
                            <td className="px-6 py-3 text-base" colSpan={2}>
                                Grand Total
                            </td>
                            <td className="px-6 py-3">Rp {grandTotal}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
